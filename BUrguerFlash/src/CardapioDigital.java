public class CardapioDigital{
    ...
    private float precoTotal, precoBebida, precoHamburguer, precoAcompanhamento, precoSobremesa, precoAdicHam, precoAdicBeb, precoAdicSorv, precoAdicBat;
    ...
    protected void mostrarAdicionalHamb(){
        if (getAberto()) {
    ...
    protected void mostrarAdicionalBat(){
        if (getAberto()) {
            System.out.println("====== ADICIONAIS ======");
    ...
    protected void mostrarAdicionalSorv(){
        if (getAberto()) {
            System.out.println("====== ADICIONAIS ======");
    ...
    protected void mostrarAdicionalBeb(){
        if (getAberto()) {
            System.out.println("====== ADICIONAIS ======");
